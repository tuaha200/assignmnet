...
ssh_params = {
    'ip': '192.168.56.101',  # Replace with your device's IP address
    'user': 'prne',           # Replace with your SSH username
    'passwd': 'cisco123!',    # Replace with your SSH password
    'enable_pass': 'class123!', # Replace with your enable password
    'syslog_server_ip': '192.168.1.100',  # Replace with your syslog server's IP address
    'hardening_file': 'cisco_hardening_guidelines.txt'  # File containing Cisco hardening guidelines
}
